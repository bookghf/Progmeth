...
public class TestBasicCharacterCard {
	...
	public void setUp() {
		...
		testChar 
		= new BasicCharacterCard("Test Character", "test character", 150, 80, 60);
	}
	...
	public void testSwitchCharacter() {
		...
		BasicCharacterCard testChar2 
		= new BasicCharacterCard("Test Character 2", "test character 2", 200, 100, 80);
