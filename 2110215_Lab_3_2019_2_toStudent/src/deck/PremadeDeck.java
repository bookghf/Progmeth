...
public class PremadeDeck {
	...
	static MainCharacterCard darkMagician = new MainCharacterCard("Dark Magician", "He's magic and stuff", 300, 70, 15,0.3f);
	static MainCharacterCard darkMagicianGirl = new MainCharacterCard("Dark Magician Girl", "She's magic and stuff", 250, 85, 15,0.4f);
	static MainCharacterCard blasterBlade = new MainCharacterCard("Blaster Blade", "He's sword and stuff", 600, 50, 18,0.35f);
	static MainCharacterCard alfred = new MainCharacterCard("Alfred", "He's king and stuff", 700, 40, 20,0.25f);
	static MainCharacterCard drgOfDestiny = new MainCharacterCard("Dragon of Destiny", "He's dragon and stuff", 500, 80, 0,0.2f);
	static MainCharacterCard aquaSurfer = new MainCharacterCard("Aqua Surfer", "He's surf and stuff", 600, 40, 25,0.4f);
	...
	static Card[] default_ = { 
			mage,mage,mage,mage
			,knight,knight,knight,knight
			,dragon,dragon,dragon,dragon
			,sword,sword,sword,shield,shield,shield,armor,armor,armor
			,longSword,longSword,longSword,longSword
			,largeShield,largeShield,largeShield,largeShield
			,largeArmor,largeArmor,largeArmor,largeArmor		
};
	
	static Card[] darkMag = { darkMagician,darkMagician,darkMagician,darkMagician
						,darkMagicianGirl,darkMagicianGirl,darkMagicianGirl,darkMagicianGirl
						,mage,mage,mage,mage
						,lightmage,lightmage,lightmage,lightmage
						,darkmage,darkmage,darkmage,darkmage
						,sword,sword,sword,shield,shield,shield,armor,armor,armor
						,longSword,longSword,longSword,longSword
						,lightSword,lightSword,lightSword,lightSword
						,darkSword,darkSword,darkSword,darkSword			
	};
	static Card[] blastBlade = { blasterBlade,blasterBlade,blasterBlade,blasterBlade
			...
			,sword,sword,sword,shield,shield,shield,armor,armor,armor
			,largeShield,largeShield,largeShield,largeShield
			,lightShield,lightShield,lightShield,lightShield
			,darkShield,darkShield,darkShield,darkShield			
	};
	static Card[] desDragon = { drgOfDestiny,drgOfDestiny,drgOfDestiny,drgOfDestiny
			,aquaSurfer,aquaSurfer,aquaSurfer,aquaSurfer
			,dragon,dragon,dragon,dragon
			,beast,beast,beast,beast
			,monster,monster,monster,monster
			,sword,sword,sword,shield,shield,shield,armor,armor,armor
			,largeArmor,largeArmor,largeArmor,largeArmor
			,lightArmor,lightArmor,lightArmor,lightArmor
			,darkArmor,darkArmor,darkArmor,darkArmor			
	};
	static Card[] exodiaD = { 	exodia,exodiaLArm,exodiaRArm,exodiaLLeg,exodiaRLeg	
