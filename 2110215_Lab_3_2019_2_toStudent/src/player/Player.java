...
public class Player {
	...
	public String toString() {
		return new StringBuilder()
				...
				.append(this.getAssignedCharacter()== null?this.getName():this.getAssignedCharacter().getName()).append("}")
				.append(":[")
				.append("LP:").append(this.getCurrentLifePoint()).append("/").append(this.getMaxLifePoint())
